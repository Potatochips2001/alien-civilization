...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('new-galaxy-select').addEventListener('change', ()=>{
        let galaxyOption = document.getElementById('new-galaxy-select').value;
        switch (galaxyOption){
            case 'milky-way':{
                document.getElementById('new-stars').value = 100;
                document.getElementById('new-galaxy-diameter').value = '260,000';
                document.getElementById('new-galaxy-thickness').value = '2,000';
                break;
            }
            case 'andromeda':{
                document.getElementById('new-stars').value = 1000;
                document.getElementById('new-galaxy-diameter').value = '220,000';
                document.getElementById('new-galaxy-thickness').value = '2,600';
                break;
            }
            default:{
                return 1;
